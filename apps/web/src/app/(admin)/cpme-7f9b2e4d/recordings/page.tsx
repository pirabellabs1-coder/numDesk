...
export default function AdminRecordingsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-on-surface" style={{ fontFamily: "Inter, sans-serif" }}>Gestion des enregistrements</h1>
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="rounded-2xl border border-white/5 bg-card p-5">
          ...
          <p className="mt-1 text-3xl font-bold text-on-surface" style={{ fontFamily: "Inter, sans-serif" }}>{estimatedFiles.toLocaleString("fr-FR")}</p>
        </div>
        <div className="rounded-2xl border border-white/5 bg-card p-5">
          <p className="text-[10px] font-bold uppercase tracking-widest text-on-surface-variant">Stockage estimé</p>
          <p className="mt-1 text-3xl font-bold text-on-surface" style={{ fontFamily: "Inter, sans-serif" }}>{estimatedStorageGB} Go</p>
        </div>
        <div className="rounded-2xl border border-white/5 bg-card p-5">
          <p className="text-[10px] font-bold uppercase tracking-widest text-on-surface-variant">Rétention par défaut</p>
          <p className="mt-1 text-3xl font-bold text-on-surface" style={{ fontFamily: "Inter, sans-serif" }}>{retentionDays} j</p>
        </div>
        <div className="rounded-2xl border border-white/5 bg-card p-5">
